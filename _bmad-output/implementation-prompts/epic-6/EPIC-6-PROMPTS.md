...
> **Story file:** `_bmad-output/implementation-artifacts/stories/6-1-menu-du-jour-et-recettes.md`
...
<step id="0" name="GIT-SYNC" CRITICAL="TRUE">
  <action>
    - Ensure you are working on the correct EPIC branch: `feat/epic-6-alimentation-recettes`
    - If branch doesn't exist: `git checkout -b feat/epic-6-alimentation-recettes origin/dev`
    - If branch exists: `git checkout feat/epic-6-alimentation-recettes`
...
**Story file path:** `_bmad-output/implementation-artifacts/stories/6-1-menu-du-jour-et-recettes.md`
...
- **Objective**: Menu du jour et recettes
- **Key files to modify**:
...
<step id="3" name="CREATE-STORY" condition="only-if-story-file-missing">
  <activation>
    ...
    Story identifier: 6-1
    Output path: _bmad-output/implementation-artifacts/stories/6-1-menu-du-jour-et-recettes.md
  </activation>
  <requirements>
...
<step id="5" name="TEA-TESTING" CRITICAL="TRUE">
  <activation>
    ...
    Scope: Story 6-1 — Menu du jour et recettes
  </activation>
  <requirements>
...
> **Story file:** `_bmad-output/implementation-artifacts/stories/6-2-crud-recettes-et-favoris.md`
> **Complexity:** Moyenne | **Dependencies:** 6.1
> **Epic:** 6 — Alimentation & Recettes
...
**Story file path:** `_bmad-output/implementation-artifacts/stories/6-2-crud-recettes-et-favoris.md`
...
- **Objective**: CRUD recettes et favoris
- **Key files to modify**:
...
- **Dependencies status**: Is Story 6.1 complete?
- **Implementation approach**: Review the tech-spec and planning artifacts.
...
<step id="3" name="CREATE-STORY" condition="only-if-story-file-missing">
  <activation>
    Load and execute: _bmad/core/tasks/workflow.xml
    Configuration file: _bmad/bmm/workflows/4-implementation/create-story/workflow.yaml
    Story identifier: 6-2
    Output path: _bmad-output/implementation-artifacts/stories/6-2-crud-recettes-et-favoris.md
  </activation>
  <requirements>
    - Read ALL four planning artifact files from STEP 2 before creating the story
    - Story MUST include: objective, acceptance criteria, tasks/subtasks, dev notes, file list
...
<step id="5" name="TEA-TESTING" CRITICAL="TRUE">
  <activation>
    Load agent definition: _bmad/tea/agents/tea.md
    Activate TEA agent protocol
    Scope: Story 6-2 — CRUD recettes et favoris
  </activation>
  <requirements>
    - Run existing test suite: npm run test or rtk vitest run
    - Write unit tests for new logic if applicable.
...
> **Story file:** `_bmad-output/implementation-artifacts/stories/6-3-liste-de-courses-et-contraintes-alimentaires.md`
> **Complexity:** Moyenne | **Dependencies:** 6.2
> **Epic:** 6 — Alimentation & Recettes
...
**Story file path:** `_bmad-output/implementation-artifacts/stories/6-3-liste-de-courses-et-contraintes-alimentaires.md`
...
- **Objective**: Liste de courses et contraintes alimentaires
- **Key files to modify**:
- `client/src/pages/Food.jsx` (modifier — compléter l'onglet Liste de courses + section contraintes)
- **Dependencies status**: Is Story 6.2 complete?
- **Implementation approach**: Review the tech-spec and planning artifacts.
...
<step id="3" name="CREATE-STORY" condition="only-if-story-file-missing">
  <activation>
    Load and execute: _bmad/core/tasks/workflow.xml
    Configuration file: _bmad/bmm/workflows/4-implementation/create-story/workflow.yaml
    Story identifier: 6-3
    Output path: _bmad-output/implementation-artifacts/stories/6-3-liste-de-courses-et-contraintes-alimentaires.md
  </activation>
  <requirements>
    - Read ALL four planning artifact files from STEP 2 before creating the story
    - Story MUST include: objective, acceptance criteria, tasks/subtasks, dev notes, file list
...
<step id="5" name="TEA-TESTING" CRITICAL="TRUE">
  <activation>
    Load agent definition: _bmad/tea/agents/tea.md
    Activate TEA agent protocol
    Scope: Story 6-3 — Liste de courses et contraintes alimentaires
  </activation>
  <requirements>
    - Run existing test suite: npm run test or rtk vitest run
    - Write unit tests for new logic if applicable.
