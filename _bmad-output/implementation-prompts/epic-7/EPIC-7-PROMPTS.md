...
> **Story file:** `_bmad-output/implementation-artifacts/stories/7-1-liste-des-abonnements.md`
...
<step id="0" name="GIT-SYNC" CRITICAL="TRUE">
  <action>
    - Ensure you are working on the correct EPIC branch: `feat/epic-7-gestion-des-abonnements`
    - If branch doesn't exist: `git checkout -b feat/epic-7-gestion-des-abonnements origin/dev`
    - If branch exists: `git checkout feat/epic-7-gestion-des-abonnements`
...
**Story file path:** `_bmad-output/implementation-artifacts/stories/7-1-liste-des-abonnements.md`
...
- **Objective**: Liste des abonnements
- **Key files to modify**:
...
<step id="3" name="CREATE-STORY" condition="only-if-story-file-missing">
  <activation>
    ...
    Story identifier: 7-1
    Output path: _bmad-output/implementation-artifacts/stories/7-1-liste-des-abonnements.md
  </activation>
  <requirements>
...
<step id="5" name="TEA-TESTING" CRITICAL="TRUE">
  <activation>
    ...
    Scope: Story 7-1 — Liste des abonnements
  </activation>
  <requirements>
...
> **Story file:** `_bmad-output/implementation-artifacts/stories/7-2-crud-abonnements-et-détails.md`
> **Complexity:** Moyenne | **Dependencies:** 7.1
> **Epic:** 7 — Gestion des Abonnements
...
**Story file path:** `_bmad-output/implementation-artifacts/stories/7-2-crud-abonnements-et-détails.md`
...
<step id="3" name="CREATE-STORY" condition="only-if-story-file-missing">
  <activation>
    Load and execute: _bmad/core/tasks/workflow.xml
    Configuration file: _bmad/bmm/workflows/4-implementation/create-story/workflow.yaml
    Story identifier: 7-2
    Output path: _bmad-output/implementation-artifacts/stories/7-2-crud-abonnements-et-détails.md
  </activation>
  <requirements>
    - Read ALL four planning artifact files from STEP 2 before creating the story
    - Story MUST include: objective, acceptance criteria, tasks/subtasks, dev notes, file list
...
<step id="5" name="TEA-TESTING" CRITICAL="TRUE">
  <activation>
    Load agent definition: _bmad/tea/agents/tea.md
    Activate TEA agent protocol
    Scope: Story 7-2 — CRUD abonnements et détails
  </activation>
  <requirements>
    - Run existing test suite: npm run test or rtk vitest run
    - Write unit tests for new logic if applicable.
