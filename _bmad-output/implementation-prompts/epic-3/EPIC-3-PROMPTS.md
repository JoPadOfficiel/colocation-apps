...
> **Story file:** `_bmad-output/implementation-artifacts/stories/3-1-dashboard-avec-4-widgets.md`
...
<step id="0" name="GIT-SYNC" CRITICAL="TRUE">
  <action>
    - Ensure you are working on the correct EPIC branch: `feat/epic-3-dashboard-vue-d-ensemble`
    - If branch doesn't exist: `git checkout -b feat/epic-3-dashboard-vue-d-ensemble origin/dev`
    - If branch exists: `git checkout feat/epic-3-dashboard-vue-d-ensemble`
...
**Story file path:** `_bmad-output/implementation-artifacts/stories/3-1-dashboard-avec-4-widgets.md`
...
- **Objective**: Dashboard avec 4 widgets
- **Key files to modify**:
...
<step id="3" name="CREATE-STORY" condition="only-if-story-file-missing">
  <activation>
    ...
    Output path: _bmad-output/implementation-artifacts/stories/3-1-dashboard-avec-4-widgets.md
  </activation>
  <requirements>
...
<step id="5" name="TEA-TESTING" CRITICAL="TRUE">
  <activation>
    ...
    Scope: Story 3-1 — Dashboard avec 4 widgets
  </activation>
  <requirements>
...
> **Story file:** `_bmad-output/implementation-artifacts/stories/3-2-graphique-et-activités-récentes.md`
> **Complexity:** Moyenne | **Dependencies:** 3.1
> **Epic:** 3 — Dashboard & Vue d'ensemble
...
**Story file path:** `_bmad-output/implementation-artifacts/stories/3-2-graphique-et-activités-récentes.md`
...
<step id="3" name="CREATE-STORY" condition="only-if-story-file-missing">
  <activation>
    ...
    Output path: _bmad-output/implementation-artifacts/stories/3-2-graphique-et-activités-récentes.md
  </activation>
  <requirements>
    - Read ALL four planning artifact files from STEP 2 before creating the story
    - Story MUST include: objective, acceptance criteria, tasks/subtasks, dev notes, file list
...
<step id="5" name="TEA-TESTING" CRITICAL="TRUE">
  <activation>
    Load agent definition: _bmad/tea/agents/tea.md
    Activate TEA agent protocol
    Scope: Story 3-2 — Graphique et activités récentes
  </activation>
  <requirements>
    - Run existing test suite: npm run test or rtk vitest run
    - Write unit tests for new logic if applicable.
...
> **Story file:** `_bmad-output/implementation-artifacts/stories/3-3-navigation-depuis-les-widgets.md`
> **Complexity:** Moyenne | **Dependencies:** 3.2
> **Epic:** 3 — Dashboard & Vue d'ensemble
...
**Story file path:** `_bmad-output/implementation-artifacts/stories/3-3-navigation-depuis-les-widgets.md`
...
- **Objective**: Navigation depuis les widgets
- **Key files to modify**:
...
- **Dependencies status**: Is Story 3.2 complete?
- **Implementation approach**: Review the tech-spec and planning artifacts.
...
<step id="3" name="CREATE-STORY" condition="only-if-story-file-missing">
  <activation>
    ...
    Output path: _bmad-output/implementation-artifacts/stories/3-3-navigation-depuis-les-widgets.md
  </activation>
  <requirements>
    - Read ALL four planning artifact files from STEP 2 before creating the story
    - Story MUST include: objective, acceptance criteria, tasks/subtasks, dev notes, file list
...
<step id="5" name="TEA-TESTING" CRITICAL="TRUE">
  <activation>
    Load agent definition: _bmad/tea/agents/tea.md
    Activate TEA agent protocol
    Scope: Story 3-3 — Navigation depuis les widgets
  </activation>
  <requirements>
    - Run existing test suite: npm run test or rtk vitest run
    - Write unit tests for new logic if applicable.
