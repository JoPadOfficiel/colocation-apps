...
> **Story file:** `_bmad-output/implementation-artifacts/stories/1-1-initialisation-du-projet.md`
...
<step id="0" name="GIT-SYNC" CRITICAL="TRUE">
  <action>
    - Ensure you are working on the correct EPIC branch: `feat/epic-1-fondations-projet-setup`
    - If branch doesn't exist: `git checkout -b feat/epic-1-fondations-projet-setup origin/dev`
    - If branch exists: `git checkout feat/epic-1-fondations-projet-setup`
...
**Story file path:** `_bmad-output/implementation-artifacts/stories/1-1-initialisation-du-projet.md`
...
- **Objective**: Initialisation du projet
- **Key files to modify**:
...
<step id="3" name="CREATE-STORY" condition="only-if-story-file-missing">
  <activation>
    ...
    Output path: _bmad-output/implementation-artifacts/stories/1-1-initialisation-du-projet.md
  </activation>
  <requirements>
...
<step id="5" name="TEA-TESTING" CRITICAL="TRUE">
  <activation>
    ...
    Scope: Story 1-1 — Initialisation du projet
  </activation>
  <requirements>
...
> **Story file:** `_bmad-output/implementation-artifacts/stories/1-2-layout-responsive-et-navigation.md`
> **Complexity:** Moyenne | **Dependencies:** 1.1
> **Epic:** 1 — Fondations & Projet Setup
...
**Story file path:** `_bmad-output/implementation-artifacts/stories/1-2-layout-responsive-et-navigation.md`
...
- **Objective**: Layout responsive et navigation
- **Key files to modify**:
...
- **Dependencies status**: Is Story 1.1 complete?
- **Implementation approach**: Review the tech-spec and planning artifacts.
...
<step id="3" name="CREATE-STORY" condition="only-if-story-file-missing">
  <activation>
    ...
    Output path: _bmad-output/implementation-artifacts/stories/1-2-layout-responsive-et-navigation.md
  </activation>
  <requirements>
    - Read ALL four planning artifact files from STEP 2 before creating the story
    - Story MUST include: objective, acceptance criteria, tasks/subtasks, dev notes, file list
...
<step id="5" name="TEA-TESTING" CRITICAL="TRUE">
  <activation>
    Load agent definition: _bmad/tea/agents/tea.md
    Activate TEA agent protocol
    Scope: Story 1-2 — Layout responsive et navigation
  </activation>
  <requirements>
    - Run existing test suite: npm run test or rtk vitest run
    - Write unit tests for new logic if applicable.
...
> **Story file:** `_bmad-output/implementation-artifacts/stories/1-3-authcontext-et-mock-data.md`
> **Complexity:** Moyenne | **Dependencies:** 1.2
> **Epic:** 1 — Fondations & Projet Setup
...
**Story file path:** `_bmad-output/implementation-artifacts/stories/1-3-authcontext-et-mock-data.md`
...
- **Objective**: AuthContext et mock data
- **Key files to modify**:
...
- **Dependencies status**: Is Story 1.2 complete?
- **Implementation approach**: Review the tech-spec and planning artifacts.
...
<step id="3" name="CREATE-STORY" condition="only-if-story-file-missing">
  <activation>
    ...
    Output path: _bmad-output/implementation-artifacts/stories/1-3-authcontext-et-mock-data.md
  </activation>
  <requirements>
    - Read ALL four planning artifact files from STEP 2 before creating the story
    - Story MUST include: objective, acceptance criteria, tasks/subtasks, dev notes, file list
...
<step id="5" name="TEA-TESTING" CRITICAL="TRUE">
  <activation>
    Load agent definition: _bmad/tea/agents/tea.md
    Activate TEA agent protocol
    Scope: Story 1-3 — AuthContext et mock data
  </activation>
  <requirements>
    - Run existing test suite: npm run test or rtk vitest run
    - Write unit tests for new logic if applicable.
